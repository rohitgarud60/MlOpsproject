...
train_data_dir = '/root/Desktop/mldevpro/monkey_breed/train'
validation_data_dir = '/root/Desktop/mldevpro/monkey_breed/validation'
...
if final_accuracy < 0.94:
    os.system("curl --user '<jenkins username>:<jenkins_password>' http://192.168.99.101:8080/job/MlOps-job1/build?token=train")
else:
    print("Your accuracy is =",final_accuracy)
